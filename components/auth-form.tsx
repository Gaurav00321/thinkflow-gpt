    ...
    <div className="w-full space-y-4 sm:space-y-6">
      <div className="text-center mb-4 sm:mb-6">
        ...
        <p className="text-purple-300/80 text-sm">
          The advanced AI automation platform
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="signin" className="space-y-4 mt-4 sm:mt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <GlowingInput type="password" placeholder="Password" />
          ...
          <div className="relative my-4 sm:my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-black/30 px-2 text-purple-300 backdrop-blur-sm">
                Or continue with
              </span>
            </div>
          </div>
        ...
        <TabsContent value="signup" className="space-y-4 mt-4 sm:mt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <GlowingInput type="password" placeholder="Password" />
            <GlowingInput type="password" placeholder="Confirm Password" />
  ...
  return (
    <div
      className={`relative transition-all duration-300 ${
        isFocused ? "shadow-[0_0_10px_rgba(149,76,233,0.5)]" : ""
      }`}
    >
